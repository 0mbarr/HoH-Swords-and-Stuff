/* namespace Upgrades
{
	class sas_ItemShop : UpgradeShop
	{
		SValue@ m_sval;

		sas_ItemShop(SValue& params)
		{
			super(params);
	...
	class sas_ItemShopIterator : ShopIterator
	{
		int m_index;

		sas_ItemShopIterator(Shop@ shop, int level, PlayerRecord@ record)
		{
